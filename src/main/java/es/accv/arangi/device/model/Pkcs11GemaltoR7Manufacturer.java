 ...
 */
public class Pkcs11GemaltoR7Manufacturer extends Pkcs11Manufacturer {

	/**
	 * Logger de la clase
	 */
	Logger logger = Logger.getLogger(Pkcs11GemaltoR7Manufacturer.class);
	
	/**
	 * Constante con el nombre del fabricante
	 */
	public static final String MANUFACTURER_NAME = "GemaltoR7";
	
	/**
	 * Constante con el nombre del módulo para tratar tarjetas
	 */
	public static final String MODULE_NAME = "IDPrimePKCS11.dll";
	 ...
	 */
	public Pkcs11GemaltoR7Manufacturer() throws IAIKDLLNotFoundException, NoSuitableDriversException {
