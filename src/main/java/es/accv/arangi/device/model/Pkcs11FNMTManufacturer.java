 ...
 */
public class Pkcs11FNMTManufacturer extends Pkcs11Manufacturer {

	/**
	 * Logger de la clase
	 */
	Logger logger = Logger.getLogger(Pkcs11FNMTManufacturer.class);
	
	/**
	 * Constante con el nombre del fabricante
	 */
	public static final String MANUFACTURER_NAME = "FNMT";
	
	/**
	 * Constante con el nombre del módulo para tratar tarjetas
	 */
	public static final String MODULE_NAME = "PkcsV2GK.dll";
	 ...
	 */
	public Pkcs11FNMTManufacturer() throws IAIKDLLNotFoundException, NoSuitableDriversException {
