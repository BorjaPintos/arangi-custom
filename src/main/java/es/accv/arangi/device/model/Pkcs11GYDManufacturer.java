...
/**
 * Clase para tratar las particularidades del fabricante de tarjetas G&D.
 * 
 * @author <a href="mailto:jgutierrez@accv.es">José M Gutiérrez</a>
 */
public class Pkcs11GYDManufacturer extends Pkcs11Manufacturer {

	/**
	 * Logger de la clase
	 */
	Logger logger = Logger.getLogger(Pkcs11GYDManufacturer.class);
	
	/**
	 * Constante con el nombre del fabricante
	 */
	public static final String MANUFACTURER_NAME = "g&d";
	
	/**
	 * Constante con el nombre del módulo para tratar tarjetas
	 */
	public static final String MODULE_NAME = "aetpkss1.dll";
	 ...
	 */
	public Pkcs11GYDManufacturer() throws IAIKDLLNotFoundException, NoSuitableDriversException {
