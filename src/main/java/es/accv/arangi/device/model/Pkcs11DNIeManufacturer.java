 ...
 */
public class Pkcs11DNIeManufacturer extends Pkcs11Manufacturer {

	/**
	 * Logger de la clase
	 */
	Logger logger = Logger.getLogger(Pkcs11DNIeManufacturer.class);
	
	/**
	 * Constante con el nombre del fabricante
	 */
	public static final String MANUFACTURER_NAME = "dnie";
	
	/**
	 * Constante con el nombre del módulo para tratar tarjetas
	 */
	public static final String MODULE_NAME = "UsrPkcs11.dll";
	 ...
	 */
	public Pkcs11DNIeManufacturer() throws IAIKDLLNotFoundException, NoSuitableDriversException {
	...
	protected String[] getX86LibrariesNames() {
		return new String[] {
//				"DNIeCSP.dll",
//				"UsrDNIeCertStore.dll",
//				"UsrASN1parser.dll",
//				"UsrCServiceProvider.dll",
//				"UsrSCardCOM.dll",
//				"UsrPkcs11.dll"
		};
	}
