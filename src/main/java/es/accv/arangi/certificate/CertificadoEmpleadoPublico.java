...
/**
 * Clase para el tratamiento de los certificados reconocidos de empleado público de la ACCV, 
...
public class CertificadoEmpleadoPublico extends CertificadoPersona implements CertificadoEmpleado {
	...
	/**
	 * OID base de los campos del SAN para la versión 1 de la política
	 */
	public static final String OID_SAN_VERSION_1 = "1.3.6.1.4.1.99999.1.4.4.4"; 
	
	/**
	 * OID base de los campos del SAN para la versión 2 de la política
	 */
	public static final String OID_SAN_VERSION_2 = "1.3.6.1.4.1.14862.1.4.4.2"; 
	
	/**
	 * OID base de los campos del SAN para la versión 3 de la política
	 */
	public static final String OID_SAN_VERSION_3 = "2.16.724.1.3.5.3.2"; 
	
	/**
	 * OID base de los campos del SAN para la versión 4 de la política
	 */
	public static final String OID_SAN_VERSION_4 = "2.16.724.1.3.5.7.2"; 
	
	/**
	 * Sufijo del OID del campo con el cargo del empleado público
	 */
	...
	/**
	 * Sufijo del OID del campo con la unidad del empleado público
	 */
	...
	public String getEmail () {
		...
		try {
			...
			logger.info ("[CertificadoEmpleadoPublico.getEmail]::No ha sido posible obtener el e-mail del empleado público", e);
			return null;
		}
	...
	public String getPosition() {
		...
		try {
			...
			logger.info ("[CertificadoEmpleadoPublico.getCargo]::No se puede obtener el cargo del empleado público", e);
			return null;
		}
	}
	...
	/**
	 * Método que obtiene el NRP/NIP del Empleado Público.
	 * 
	 * @return NRP/NIP del Empleado Público
	 */
	public String getNRP() {
		...
		try {
			...
			logger.info ("[CertificadoEmpleadoPublico.getNRP]::No se puede obtener el nrp/nip del empleado público", e);
			return null;
		}
	}
	...
	public String getOrganizationalUnit() {
	    ...
	    try {
			...
			logger.info ("[CertificadoEmpleadoPublico.getCargo]::No se puede obtener la unidad del empleado público", e);
			return null;
		}
	}
	...
	public static CAList getCAList() throws CertificateCANotFoundException {
		...
		try {
			...
			logger.info ("[CertificadoEmpleadoPublico.getCAList]::No ha sido posible parsear el fichero de validación XML", e);
			...
			logger.info ("[CertificadoEmpleadoPublico.getCAList]::No ha sido posible obtener el fichero de validación XML", e);
		}
