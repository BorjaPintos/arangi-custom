...
public class CertificadoCiudadano extends CertificadoPersona  {
	...
	/**
	 * Base del OID de la política de certificados de ciudadano en dispositivo seguro
	 */
	public static final String POLICY_IN_PKCS11_DEVICE = "1.3.6.1.4.1.8149.3.6";

	/**
	 * Base del OID de la política de certificados de ciudadano en dispositivo software
	 */
	public static final String POLICY_IN_SOFTWARE_DEVICE = "1.3.6.1.4.1.8149.3.7";

	/**
	 * Base del OID de la política de certificados de ciudadano en la nube
	 */
	...
	public static CAList getCAList() throws CertificateCANotFoundException {
		...
		try {
			...
			logger.info ("[CertificadoCiudadano.getCAList]::No ha sido posible parsear el fichero de validación XML", e);
			...
			logger.info ("[CertificadoCiudadano.getCAList]::No ha sido posible obtener el fichero de validación XML", e);
		}
	...
	protected static String [] getBasePolicies () {
		return new String[] {
				POLICY_IN_PKCS11_DEVICE, // versión en DS
	...
	private static List getCAListTest() throws CertificateCANotFoundException {
		...
		//-- Añadir los certificados de test
		List lCACertificates = new ArrayList ();
